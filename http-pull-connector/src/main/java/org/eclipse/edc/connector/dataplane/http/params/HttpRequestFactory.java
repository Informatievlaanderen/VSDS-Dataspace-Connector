...
public class HttpRequestFactory {
    ...
    public Request toRequest(HttpRequestParams params) {
        ...
        return toRequest(params, Map.of(), bodySupplier);
    }
     ...
     * @return HTTP request.
     */
    public Request toRequest(HttpRequestParams params, Map<String, String> additionalHeaders, Supplier<InputStream> bodySupplier) {
