# Implement a simple flow from a LdesServer to a LdesClient with the extended http connectors.
...
The final goal of this example is to show the use of the extended http connector, showing it carries headers and a http status code.
...
* Performing a transfer
    ...
    * The provider will send the requested data to the consumer
...
The provider connector is the one providing data to the consumer after it initiates
a transfer.
...
### 13. Using the public API

The LDES client will now 
